...
export function Navbar({ lang }: { lang: string }) {
  ...
  return (
    <nav
      className={`fixed top-4 left-1/2 z-20 flex -translate-x-1/2 items-center justify-between rounded bg-[#1a1a1a]/60 p-1 backdrop-blur-xl transition-[width,max-width] duration-300 ease-out ${
        scrolled
